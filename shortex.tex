...
You can also disable all comments to see the clean version of the current document using the \verb!\suppresscomments! command.
...
partial derivative coordinate & \verb!\pderi{x}{y}{i}! & $\pderi{x}{y}{i}$ \\
