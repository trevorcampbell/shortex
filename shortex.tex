...
\usepackage[commenters={AB,CD}]{shortex}
...
\item[\texttt{suppresscomments}] Suppress comments.
\edesc
...
Here is an example of how these look in a typical paragraph with two commenters
AB and CD with shortex package options \verb!\usepackage[commenters={AB,CD}]{shortex}!:

\begin{quote}
Lorem ipsum dolor sit amet\cAB{Here is an inline comment}, consectetur adipiscing elit, sed do eiusmod tempor
incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
nostrud exercitation\eCD{Here is an inline emphasized comment} ullamco laboris nisi ut aliquip ex ea commodo consequat.
Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
fugiat nulla pariatur. Excepteur sint\mAB{Here is a margin comment} occaecat cupidatat non proident, sunt.
\hCD{Here is a highlighted part of the text.} sed do eiusmod tempor
incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
\end{quote}

You can also disable all comments to see a clean version of the current document using the \verb!\suppresscomments! package option.
