...
\verb!\lowercaseGreek! & alpha,beta,gamma,delta,eps,zeta,eta,theta,iota,kappa,lambda,mu,nu,xi,pi,rho\\
& sigma,tau,ups,phi,chi,psi,omega,veps,vtheta,vkappa,vpi,vrho,vsigma,vphi\\
\verb!\uppercaseGreek! & Gamma,Delta,Theta,Lambda,Xi,Pi,Sigma,Ups,Phi,Psi,Omega\\
\bottomrule
\etabr
\ecent
...
\btabr[c]{@{}l@{}}$\Lp{p}$ space for \\ specified measure	 \end{tabular}	& \verb!\Lpm{2}{\mu}!	& $\Lpm{2}{\mu}$ 		\\[10pt]
...
\btabr[c]{@{}l@{}}$\Lp{p}$ norm for \\ specified measure	 \end{tabular}		& \verb!\Lpmnorm{\Gamma}{2}{\mu}!        & $\Lpmnorm{\Gamma}{2}{\mu}$  \\[10pt]
...
\btabr[c]{@{}l@{}}$\Lp{p}$ inner product \\  for specified measure	 \end{tabular} & \verb!\Lpminner{\Gamma}{\Gamma}{2}{\mu}!        & $\Lpminner{\Gamma}{\Gamma}{2}{\mu}$ 	 \\[10pt]
