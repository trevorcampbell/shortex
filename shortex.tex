...
\usepackage[subtlehypersetup]{shortex}
...
\section{Usage, options, and workflow}
Include ShorTeX by adding \verb!\usepackage{shortex}! to the preamble of your document.
The package has a few options:
\bdesc
\item[\texttt{manualnumbering}] Asdf
\item[\texttt{subtlehypersetup}] Asdf
\item[\texttt{blackhypersetup}] Asdf
\edesc
...
\subsection{Automated references for equations, figures, tables}

\subsection{Automatic equation numbering}
